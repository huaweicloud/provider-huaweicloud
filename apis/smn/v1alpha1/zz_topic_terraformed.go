...
func (tr *Topic) LateInitialize(attrs []byte) (bool, error) {
	...
	opts = append(opts, resource.WithConditionalFilter("AccessPolicy", initParams))
	opts = append(opts, resource.WithConditionalFilter("ServicesPublishAllowed", initParams))
	opts = append(opts, resource.WithConditionalFilter("UsersPublishAllowed", initParams))
