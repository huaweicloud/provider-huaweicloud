...
func (mg *SubscriptionFilterPolicy) GetTerraformResourceType() string {
	return "huaweicloud_smn_subscription_filter_policy"
}
...
// LateInitialize this SubscriptionFilterPolicy using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SubscriptionFilterPolicy) LateInitialize(attrs []byte) (bool, error) {
	params := &SubscriptionFilterPolicyParameters{}
