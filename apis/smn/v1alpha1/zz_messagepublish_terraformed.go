...
func (mg *MessagePublish) GetTerraformResourceType() string {
	return "huaweicloud_smn_message_publish"
}
...
// LateInitialize this MessagePublish using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *MessagePublish) LateInitialize(attrs []byte) (bool, error) {
	params := &MessagePublishParameters{}
	...
	opts = append(opts, resource.WithConditionalFilter("Message", initParams))
	opts = append(opts, resource.WithConditionalFilter("MessageStructure", initParams))
	opts = append(opts, resource.WithConditionalFilter("MessageTemplateName", initParams))
