...
func (mg *Alarmrule) GetTerraformResourceType() string {
	return "huaweicloud_ces_alarmrule"
}
...
// GetInitParameters of this Alarmrule
func (tr *Alarmrule) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Alarmrule
func (tr *Alarmrule) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
func (tr *Alarmrule) LateInitialize(attrs []byte) (bool, error) {
	...
	opts = append(opts, resource.WithNameFilter("Metric.Dimensions"))
