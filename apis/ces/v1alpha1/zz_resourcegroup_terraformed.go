...
func (mg *ResourceGroup) GetTerraformResourceType() string {
	return "huaweicloud_ces_resource_group"
}
...
func (tr *ResourceGroup) LateInitialize(attrs []byte) (bool, error) {
	...
	opts = append(opts, resource.WithConditionalFilter("AssociatedEpsIds", initParams))
	opts = append(opts, resource.WithConditionalFilter("Resources", initParams))
	opts = append(opts, resource.WithConditionalFilter("Tags", initParams))
	opts = append(opts, resource.WithConditionalFilter("Type", initParams))
