...
type EIPBandwidthInitParameters struct {
...
type EIPBandwidthObservation struct {
...
type EIPBandwidthParameters struct {
...
type EIPInitParameters_2 struct {
	...
	Bandwidth []EIPBandwidthInitParameters `json:"bandwidth,omitempty" tf:"bandwidth,omitempty"`
...
type EIPObservation_2 struct {
	...
	// The object structure is documented below.
	// The bandwidth configuration.
	Bandwidth []EIPBandwidthObservation `json:"bandwidth,omitempty" tf:"bandwidth,omitempty"`
...
type EIPParameters_2 struct {
	...
	// The bandwidth configuration.
	// +kubebuilder:validation:Optional
	Bandwidth []EIPBandwidthParameters `json:"bandwidth,omitempty" tf:"bandwidth,omitempty"`
...
type EIPSpec struct {
	...
	ForProvider     EIPParameters_2 `json:"forProvider"`
	...
	// autoscaler.
	InitProvider EIPInitParameters_2 `json:"initProvider,omitempty"`
}

// EIPStatus defines the observed state of EIP.
type EIPStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        EIPObservation_2 `json:"atProvider,omitempty"`
}
