...
type BandwidthSpec struct {
	...
	ForProvider     BandwidthParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider BandwidthInitParameters `json:"initProvider,omitempty"`
}

// BandwidthStatus defines the observed state of Bandwidth.
type BandwidthStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        BandwidthObservation `json:"atProvider,omitempty"`
}
...
// BandwidthList contains a list of Bandwidths
...
var (
	Bandwidth_Kind             = "Bandwidth"
	Bandwidth_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: Bandwidth_Kind}.String()
	Bandwidth_KindAPIVersion   = Bandwidth_Kind + "." + CRDGroupVersion.String()
	Bandwidth_GroupVersionKind = CRDGroupVersion.WithKind(Bandwidth_Kind)
)
