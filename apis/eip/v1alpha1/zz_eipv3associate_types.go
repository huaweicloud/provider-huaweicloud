...
type Eipv3AssociateInitParameters struct {
...
type Eipv3AssociateObservation struct {
...
type Eipv3AssociateParameters struct {
...
// Eipv3AssociateSpec defines the desired state of Eipv3Associate
type Eipv3AssociateSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     Eipv3AssociateParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider Eipv3AssociateInitParameters `json:"initProvider,omitempty"`
}

// Eipv3AssociateStatus defines the observed state of Eipv3Associate.
type Eipv3AssociateStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        Eipv3AssociateObservation `json:"atProvider,omitempty"`
}
...
// Eipv3Associate is the Schema for the Eipv3Associates API. Manages a VPC EIP associates with an instance resource within HuaweiCloud.
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,huaweicloud}
type Eipv3Associate struct {
	...
	Spec   Eipv3AssociateSpec   `json:"spec"`
	Status Eipv3AssociateStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// Eipv3AssociateList contains a list of Eipv3Associates
type Eipv3AssociateList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []Eipv3Associate `json:"items"`
}

// Repository type metadata.
var (
	Eipv3Associate_Kind             = "Eipv3Associate"
	Eipv3Associate_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: Eipv3Associate_Kind}.String()
	Eipv3Associate_KindAPIVersion   = Eipv3Associate_Kind + "." + CRDGroupVersion.String()
	Eipv3Associate_GroupVersionKind = CRDGroupVersion.WithKind(Eipv3Associate_Kind)
)

func init() {
	SchemeBuilder.Register(&Eipv3Associate{}, &Eipv3AssociateList{})
}
