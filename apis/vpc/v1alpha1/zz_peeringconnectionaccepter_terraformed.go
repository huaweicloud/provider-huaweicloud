...
func (mg *PeeringConnectionAccepter) GetTerraformResourceType() string {
	return "huaweicloud_vpc_peering_connection_accepter"
}
...
// GetInitParameters of this PeeringConnectionAccepter
func (tr *PeeringConnectionAccepter) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this PeeringConnectionAccepter
func (tr *PeeringConnectionAccepter) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
