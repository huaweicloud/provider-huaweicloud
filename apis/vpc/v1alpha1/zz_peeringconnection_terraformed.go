...
func (mg *PeeringConnection) GetTerraformResourceType() string {
	return "huaweicloud_vpc_peering_connection"
}
...
// GetInitParameters of this PeeringConnection
func (tr *PeeringConnection) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this PeeringConnection
func (tr *PeeringConnection) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
