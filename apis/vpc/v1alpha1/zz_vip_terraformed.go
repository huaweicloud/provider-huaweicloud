...
func (mg *Vip) GetTerraformResourceType() string {
	return "huaweicloud_networking_vip"
}
...
// GetInitParameters of this Vip
func (tr *Vip) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Vip
func (tr *Vip) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
