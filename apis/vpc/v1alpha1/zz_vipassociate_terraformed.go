...
func (mg *VipAssociate) GetTerraformResourceType() string {
	return "huaweicloud_networking_vip_associate"
}
...
// GetInitParameters of this VipAssociate
func (tr *VipAssociate) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VipAssociate
func (tr *VipAssociate) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
