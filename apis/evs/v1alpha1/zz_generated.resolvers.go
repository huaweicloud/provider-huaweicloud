...
// ResolveReferences of this SnapshotRollback.
func (mg *SnapshotRollback) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
...
// ResolveReferences of this VolumeTransfer.
func (mg *VolumeTransfer) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
...
// ResolveReferences of this VolumeTransferAccepter.
func (mg *VolumeTransferAccepter) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		CurrentValue: reference.FromPtrValue(mg.Spec.ForProvider.TransferID),
		Extract:      resource.ExtractResourceID(),
		Reference:    mg.Spec.ForProvider.TransferIDRef,
		Selector:     mg.Spec.ForProvider.TransferIDSelector,
		To: reference.To{
			List:    &VolumeTransferList{},
			Managed: &VolumeTransfer{},
		},
	})
	if err != nil {
		return errors.Wrap(err, "mg.Spec.ForProvider.TransferID")
	}
	mg.Spec.ForProvider.TransferID = reference.ToPtrValue(rsp.ResolvedValue)
	mg.Spec.ForProvider.TransferIDRef = rsp.ResolvedReference

	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		CurrentValue: reference.FromPtrValue(mg.Spec.InitProvider.TransferID),
		Extract:      resource.ExtractResourceID(),
		Reference:    mg.Spec.InitProvider.TransferIDRef,
		Selector:     mg.Spec.InitProvider.TransferIDSelector,
		To: reference.To{
			List:    &VolumeTransferList{},
			Managed: &VolumeTransfer{},
		},
	...
	if err != nil {
		return errors.Wrap(err, "mg.Spec.InitProvider.TransferID")
	}
	mg.Spec.InitProvider.TransferID = reference.ToPtrValue(rsp.ResolvedValue)
	mg.Spec.InitProvider.TransferIDRef = rsp.ResolvedReference
