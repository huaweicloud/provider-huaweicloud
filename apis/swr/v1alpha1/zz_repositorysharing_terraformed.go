...
func (mg *RepositorySharing) GetTerraformResourceType() string {
	return "huaweicloud_swr_repository_sharing"
}
...
// GetInitParameters of this RepositorySharing
func (tr *RepositorySharing) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this RepositorySharing
func (tr *RepositorySharing) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
