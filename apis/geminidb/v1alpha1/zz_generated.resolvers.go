...
// ResolveReferences of this CassandraInstance.
func (mg *CassandraInstance) ResolveReferences(ctx context.Context, c client.Reader) error {
...
// ResolveReferences of this InfluxInstance.
func (mg *InfluxInstance) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
...
// ResolveReferences of this MongoInstance.
func (mg *MongoInstance) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
...
// ResolveReferences of this RedisEIPAssociate.
func (mg *RedisEIPAssociate) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		...
		To: reference.To{
			List:    &RedisInstanceList{},
			Managed: &RedisInstance{},
		},
	})
	if err != nil {
...
// ResolveReferences of this RedisInstance.
func (mg *RedisInstance) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
