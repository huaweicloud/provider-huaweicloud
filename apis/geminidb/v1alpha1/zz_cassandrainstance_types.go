...
type CassandraInstanceInitParameters struct {
...
type CassandraInstanceObservation struct {
...
type CassandraInstanceParameters struct {
...
// CassandraInstanceSpec defines the desired state of CassandraInstance
type CassandraInstanceSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     CassandraInstanceParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider CassandraInstanceInitParameters `json:"initProvider,omitempty"`
}

// CassandraInstanceStatus defines the observed state of CassandraInstance.
type CassandraInstanceStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        CassandraInstanceObservation `json:"atProvider,omitempty"`
}
...
// CassandraInstance is the Schema for the CassandraInstances API. ""
...
type CassandraInstance struct {
	...
	Spec   CassandraInstanceSpec   `json:"spec"`
	Status CassandraInstanceStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// CassandraInstanceList contains a list of CassandraInstances
type CassandraInstanceList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []CassandraInstance `json:"items"`
}

// Repository type metadata.
var (
	CassandraInstance_Kind             = "CassandraInstance"
	CassandraInstance_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: CassandraInstance_Kind}.String()
	CassandraInstance_KindAPIVersion   = CassandraInstance_Kind + "." + CRDGroupVersion.String()
	CassandraInstance_GroupVersionKind = CRDGroupVersion.WithKind(CassandraInstance_Kind)
)

func init() {
	SchemeBuilder.Register(&CassandraInstance{}, &CassandraInstanceList{})
}
