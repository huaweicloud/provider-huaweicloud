...
type InfluxInstanceBackupStrategyInitParameters struct {
...
type InfluxInstanceBackupStrategyObservation struct {
...
type InfluxInstanceBackupStrategyParameters struct {
...
type InfluxInstanceDatastoreInitParameters struct {
...
type InfluxInstanceDatastoreObservation struct {
...
type InfluxInstanceDatastoreParameters struct {
...
type InfluxInstanceInitParameters struct {
	...
	BackupStrategy []InfluxInstanceBackupStrategyInitParameters `json:"backupStrategy,omitempty" tf:"backup_strategy,omitempty"`
	...
	Datastore []InfluxInstanceDatastoreInitParameters `json:"datastore,omitempty" tf:"datastore,omitempty"`
...
type InfluxInstanceNodesInitParameters struct {
}

type InfluxInstanceNodesObservation struct {
...
type InfluxInstanceNodesParameters struct {
}

type InfluxInstanceObservation struct {
	...
	// Specifies the advanced backup policy. Structure is documented below.
	BackupStrategy []InfluxInstanceBackupStrategyObservation `json:"backupStrategy,omitempty" tf:"backup_strategy,omitempty"`
	...
	// Specifies the database information. Structure is documented below. Changing
	// this parameter will create a new resource.
	Datastore []InfluxInstanceDatastoreObservation `json:"datastore,omitempty" tf:"datastore,omitempty"`
	...
	Nodes []InfluxInstanceNodesObservation `json:"nodes,omitempty" tf:"nodes,omitempty"`
...
type InfluxInstanceParameters struct {
	...
	// Specifies the advanced backup policy. Structure is documented below.
	// +kubebuilder:validation:Optional
	BackupStrategy []InfluxInstanceBackupStrategyParameters `json:"backupStrategy,omitempty" tf:"backup_strategy,omitempty"`
	...
	// this parameter will create a new resource.
	// +kubebuilder:validation:Optional
	Datastore []InfluxInstanceDatastoreParameters `json:"datastore,omitempty" tf:"datastore,omitempty"`
...
// InfluxInstanceSpec defines the desired state of InfluxInstance
type InfluxInstanceSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     InfluxInstanceParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider InfluxInstanceInitParameters `json:"initProvider,omitempty"`
}

// InfluxInstanceStatus defines the observed state of InfluxInstance.
type InfluxInstanceStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        InfluxInstanceObservation `json:"atProvider,omitempty"`
}
...
// InfluxInstance is the Schema for the InfluxInstances API. ""
...
type InfluxInstance struct {
	...
	Spec   InfluxInstanceSpec   `json:"spec"`
	Status InfluxInstanceStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// InfluxInstanceList contains a list of InfluxInstances
type InfluxInstanceList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []InfluxInstance `json:"items"`
}

// Repository type metadata.
var (
	InfluxInstance_Kind             = "InfluxInstance"
	InfluxInstance_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: InfluxInstance_Kind}.String()
	InfluxInstance_KindAPIVersion   = InfluxInstance_Kind + "." + CRDGroupVersion.String()
	InfluxInstance_GroupVersionKind = CRDGroupVersion.WithKind(InfluxInstance_Kind)
)

func init() {
	SchemeBuilder.Register(&InfluxInstance{}, &InfluxInstanceList{})
}
