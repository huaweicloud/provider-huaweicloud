...
func (tr *Addon) LateInitialize(attrs []byte) (bool, error) {
	...
	opts = append(opts, resource.WithConditionalFilter("Values.Basic", initParams))
	opts = append(opts, resource.WithConditionalFilter("Values.BasicJSON", initParams))
	opts = append(opts, resource.WithConditionalFilter("Values.Custom", initParams))
	opts = append(opts, resource.WithConditionalFilter("Values.CustomJSON", initParams))
	opts = append(opts, resource.WithConditionalFilter("Values.Flavor", initParams))
	opts = append(opts, resource.WithConditionalFilter("Values.FlavorJSON", initParams))
