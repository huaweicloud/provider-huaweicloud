...
// GetInitParameters of this Pvc
func (tr *Pvc) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Pvc
func (tr *Pvc) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
