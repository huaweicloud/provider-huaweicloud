...
func (mg *Namespace) GetTerraformResourceType() string {
	return "huaweicloud_cce_namespace"
}
...
func (tr *Namespace) LateInitialize(attrs []byte) (bool, error) {
	...
	opts = append(opts, resource.WithConditionalFilter("Name", initParams))
	opts = append(opts, resource.WithConditionalFilter("Prefix", initParams))
