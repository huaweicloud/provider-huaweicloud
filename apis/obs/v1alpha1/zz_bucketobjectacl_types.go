...
type BucketObjectACLInitParameters struct {
	...
	// Specifies the name of the object to which to set the acl.
	// +crossplane:generate:reference:type=github.com/huaweicloud/provider-huaweicloud/apis/obs/v1alpha1.BucketObject
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/pkg/resource.ExtractParamPath("key",true)
...
// BucketObjectACL is the Schema for the BucketObjectACLs API. ""
