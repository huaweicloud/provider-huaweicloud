...
func (mg *RocketmqMigrationTask) GetTerraformResourceType() string {
	return "huaweicloud_dms_rocketmq_migration_task"
}
...
// LateInitialize this RocketmqMigrationTask using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *RocketmqMigrationTask) LateInitialize(attrs []byte) (bool, error) {
	params := &RocketmqMigrationTaskParameters{}
