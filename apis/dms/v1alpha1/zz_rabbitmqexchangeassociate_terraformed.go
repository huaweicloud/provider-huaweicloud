...
func (mg *RabbitmqExchangeAssociate) GetTerraformResourceType() string {
	return "huaweicloud_dms_rabbitmq_exchange_associate"
}
...
// LateInitialize this RabbitmqExchangeAssociate using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *RabbitmqExchangeAssociate) LateInitialize(attrs []byte) (bool, error) {
	params := &RabbitmqExchangeAssociateParameters{}
