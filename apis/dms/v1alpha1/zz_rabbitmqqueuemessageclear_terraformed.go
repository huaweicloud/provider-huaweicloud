...
func (mg *RabbitmqQueueMessageClear) GetTerraformResourceType() string {
	return "huaweicloud_dms_rabbitmq_queue_message_clear"
}
...
// LateInitialize this RabbitmqQueueMessageClear using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *RabbitmqQueueMessageClear) LateInitialize(attrs []byte) (bool, error) {
	params := &RabbitmqQueueMessageClearParameters{}
