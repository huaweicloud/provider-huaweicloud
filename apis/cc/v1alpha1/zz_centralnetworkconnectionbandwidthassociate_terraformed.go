...
func (mg *CentralNetworkConnectionBandwidthAssociate) GetTerraformResourceType() string {
	return "huaweicloud_cc_central_network_connection_bandwidth_associate"
}
...
func (tr *CentralNetworkConnectionBandwidthAssociate) GetID() string {
...
// LateInitialize this CentralNetworkConnectionBandwidthAssociate using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *CentralNetworkConnectionBandwidthAssociate) LateInitialize(attrs []byte) (bool, error) {
	params := &CentralNetworkConnectionBandwidthAssociateParameters{}
