...
func (mg *GlobalConnectionBandwidthAssociate) GetTerraformResourceType() string {
	return "huaweicloud_cc_global_connection_bandwidth_associate"
}
...
func (tr *GlobalConnectionBandwidthAssociate) GetID() string {
...
// LateInitialize this GlobalConnectionBandwidthAssociate using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *GlobalConnectionBandwidthAssociate) LateInitialize(attrs []byte) (bool, error) {
	params := &GlobalConnectionBandwidthAssociateParameters{}
