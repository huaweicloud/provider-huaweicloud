...
func (mg *CentralNetworkPolicyApply) GetTerraformResourceType() string {
	return "huaweicloud_cc_central_network_policy_apply"
}
...
// LateInitialize this CentralNetworkPolicyApply using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *CentralNetworkPolicyApply) LateInitialize(attrs []byte) (bool, error) {
	params := &CentralNetworkPolicyApplyParameters{}
