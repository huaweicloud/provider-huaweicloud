...
func (mg *GlobalConnectionBandwidth) GetTerraformResourceType() string {
	return "huaweicloud_cc_global_connection_bandwidth"
}
...
// LateInitialize this GlobalConnectionBandwidth using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *GlobalConnectionBandwidth) LateInitialize(attrs []byte) (bool, error) {
	params := &GlobalConnectionBandwidthParameters{}
