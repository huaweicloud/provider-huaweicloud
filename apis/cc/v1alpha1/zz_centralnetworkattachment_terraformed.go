...
func (mg *CentralNetworkAttachment) GetTerraformResourceType() string {
	return "huaweicloud_cc_central_network_attachment"
}
...
// LateInitialize this CentralNetworkAttachment using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *CentralNetworkAttachment) LateInitialize(attrs []byte) (bool, error) {
	params := &CentralNetworkAttachmentParameters{}
