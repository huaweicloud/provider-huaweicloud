...
func (mg *SnatRule) GetTerraformResourceType() string {
	return "huaweicloud_nat_snat_rule"
}
...
// GetInitParameters of this SnatRule
func (tr *SnatRule) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this SnatRule
func (tr *SnatRule) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
