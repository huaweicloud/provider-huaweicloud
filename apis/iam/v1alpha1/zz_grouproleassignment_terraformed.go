...
func (mg *GroupRoleAssignment) GetTerraformResourceType() string {
	return "huaweicloud_identity_group_role_assignment"
}
...
// LateInitialize this GroupRoleAssignment using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *GroupRoleAssignment) LateInitialize(attrs []byte) (bool, error) {
	params := &GroupRoleAssignmentParameters{}
	...
	opts = append(opts, resource.WithConditionalFilter("DomainID", initParams))
	opts = append(opts, resource.WithConditionalFilter("EnterpriseProjectID", initParams))
	opts = append(opts, resource.WithConditionalFilter("ProjectID", initParams))
