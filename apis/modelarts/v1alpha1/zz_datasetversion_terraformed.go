...
func (mg *DatasetVersion) GetTerraformResourceType() string {
	return "huaweicloud_modelarts_dataset_version"
}
...
// GetInitParameters of this DatasetVersion
func (tr *DatasetVersion) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this DatasetVersion
func (tr *DatasetVersion) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
