...
type DatasetVersionInitParameters struct {

	// Specifies the ID of dataset.
	// Changing this parameter will create a new resource.
	// +crossplane:generate:reference:type=github.com/huaweicloud/provider-huaweicloud/apis/modelarts/v1alpha1.Dataset
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/pkg/resource.ExtractResourceID()
	DatasetID *string `json:"datasetId,omitempty" tf:"dataset_id,omitempty"`

	// Reference to a Dataset in modelarts to populate datasetId.
	// +kubebuilder:validation:Optional
	DatasetIDRef *v1.Reference `json:"datasetIdRef,omitempty" tf:"-"`

	// Selector for a Dataset in modelarts to populate datasetId.
	// +kubebuilder:validation:Optional
...
type DatasetVersionSpec struct {
	...
	// autoscaler.
	InitProvider DatasetVersionInitParameters `json:"initProvider,omitempty"`
}
...
// DatasetVersion is the Schema for the DatasetVersions API. ""
