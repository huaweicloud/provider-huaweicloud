...
var ExternalNameConfigs = map[string]config.ExternalName{
	...
	// kafka
	"huaweicloud_dms_kafka_background_task_delete":            config.IdentifierFromProvider,
	"huaweicloud_dms_kafka_consumer_group_topic_batch_delete": config.IdentifierFromProvider,
	"huaweicloud_dms_kafka_consumer_group":                    config.IdentifierFromProvider,
	"huaweicloud_dms_kafka_instance_batch_action":             config.IdentifierFromProvider,
	"huaweicloud_dms_kafka_instance":                          config.IdentifierFromProvider,
	"huaweicloud_dms_kafka_instance_rebalance_log":            config.IdentifierFromProvider,
	"huaweicloud_dms_kafka_instance_restart":                  config.IdentifierFromProvider,
	"huaweicloud_dms_kafka_message_diagnosis_task":            config.IdentifierFromProvider,
	"huaweicloud_dms_kafka_message_offset_reset":              config.IdentifierFromProvider,
	"huaweicloud_dms_kafka_message_produce":                   config.IdentifierFromProvider,
	"huaweicloud_dms_kafka_partition_reassign":                config.IdentifierFromProvider,
	"huaweicloud_dms_kafka_permissions":                       config.IdentifierFromProvider,
	"huaweicloud_dms_kafka_smart_connect":                     config.IdentifierFromProvider,
	"huaweicloud_dms_kafka_smart_connect_task":                config.IdentifierFromProvider,
	"huaweicloud_dms_kafkav2_smart_connect_task":              config.IdentifierFromProvider,
	"huaweicloud_dms_kafka_smart_connect_task_action":         config.IdentifierFromProvider,
	"huaweicloud_dms_kafka_smart_connector_validate":          config.IdentifierFromProvider,
	"huaweicloud_dms_kafka_topic":                             config.IdentifierFromProvider,
	"huaweicloud_dms_kafka_topic_quota":                       config.IdentifierFromProvider,
	"huaweicloud_dms_kafka_user":                              config.IdentifierFromProvider,
	"huaweicloud_dms_kafka_user_client_quota":                 config.IdentifierFromProvider,
	"huaweicloud_dms_kafka_user_password_reset":               config.IdentifierFromProvider,
