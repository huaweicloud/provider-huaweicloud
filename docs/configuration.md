...
spec:
  package: xpkg.upbound.io/niuzhenguo/provider-huaweicloud:<version>
```
...
provider-huaweicloud      True        True      xpkg.upbound.io/huaweicloud/provider-huaweicloud:v0.0.1    62s
```
